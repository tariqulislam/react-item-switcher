...
export class ItemSwitcher extends Component {
  ...
  componentDidMount() {
    this.setState({
      ItemList: this.props.items || this.props.defaultItemList,
      immutableItemList: this.props.items || this.props.defaultItemList
    });
  }
  ...
  getSelectedSwitcherValue = () => {
    ...
    if(typeof this.props.getSelectedValue === 'function') {
